...
3. Mention details about your platform: OS, version of gopherjs, browser, etc.

### Pull Requests

Router uses semantic versioning and the [git branching model described here](http://nvie.com/posts/a-successful-git-branching-model/).
